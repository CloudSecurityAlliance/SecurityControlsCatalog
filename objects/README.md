...
| Content | Objects | Generated by |
|---|---|---|
| AICM 1.1.0 controls | 247 | [`tools/generate_aicm_controls.py`](../tools/generate_aicm_controls.py) |
| AI-CAIQ 1.1.0 questions | 320 | [`tools/generate_aicm_caiq.py`](../tools/generate_aicm_caiq.py) |
| EU AI Act provisions | 106 | [`tools/generate_aicm_eu_mappings.py`](../tools/generate_aicm_eu_mappings.py) |
| Cited standards (BSI AIC4/C5, ISO 42001/27001/27002) | 420 | [`tools/generate_aicm_standard_mappings.py`](../tools/generate_aicm_standard_mappings.py) |
| Question-to-control links (`derived-from`) | 320 | — |
| Coverage verdicts (`x-gap-mapping`) | 423 | — |
| **Total committed objects** | **1845** | |
...
Mapping coverage is partial and deliberately so: what could not be resolved to a
specific control in a specific standard is recorded in
[`../quarantine/`](../quarantine/) rather than guessed at, because a guessed
reference becomes a permanent identifier. The open questions with the publisher are
tracked as issues
...
[#26](https://github.com/CloudSecurityAlliance/SecurityControlsCatalog/issues/26),
[#27](https://github.com/CloudSecurityAlliance/SecurityControlsCatalog/issues/27),
and [#28](https://github.com/CloudSecurityAlliance/SecurityControlsCatalog/issues/28).
